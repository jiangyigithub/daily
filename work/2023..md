...
>> 进到/home/hny2wx/eci-linux/EciLinux_amd64/src/KernelModule目录下，执行sudo make install
...
2. 制作容器
sudo docker run -it --privileged --name icv-lukas -v /home/hny2wx/workspace:/workspace boschicv/icv-noetic:v5.0
